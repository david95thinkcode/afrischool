    ...
    <div class="left_col scroll-view">
        ...
        <div class="menu_section">
            ...
            <ul class="nav side-menu">
                ...
                @if ((Auth::user()->hasRole('comptable')) || (Auth::user()->hasRole('censeur')) || (Auth::user()->hasRole('fondateur')) || (Auth::user()->hasRole('directeur')))
                ...
                @if ((Auth::user()->hasRole('comptable')) || (Auth::user()->hasRole('fondateur')) || (Auth::user()->hasRole('directeur')) || (Auth::user()->hasRole('censeur')))
                <li>
                ...
                @if ((Auth::user()->hasRole('surveillant')) || (Auth::user()->hasRole('fondateur')) || (Auth::user()->hasRole('directeur')) || (Auth::user()->hasRole('censeur')))
                <li>
