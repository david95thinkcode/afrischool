...
@section('title') Obtention du bulletin de notes @endsection
@section('section-title') Obtention du bulletin de notes @endsection
@section('content')
    <div class='row'>
        <div class="col-md-5 col-md-offset-3 col-sm-6 col-sm-offset-3 col-xs-12">
            <div class="panel panel-default">
                <div class="panel-body">
                    <div class="x-content">
                        {!! Form::open(['route' => ['notes.bulletin.second'], 'method' => 'POST']) !!}
