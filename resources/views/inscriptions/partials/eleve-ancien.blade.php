...
<div class="row">
    <div class="col-md-6 col-xs-12">
        ...
        <div class="form-check form-check-inline">
            <input class="form-check-input" type="radio" id='ancien-oui' name="ancien" value="1" checked>
            <label class="form-check-label" for="ancien-oui">Oui</label>

            <input class="form-check-input" type="radio" id="ancien-non" name="ancien" value="0">
